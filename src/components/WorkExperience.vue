...
<template>
  <section id="experience" class="experience">
    <div class="container">
      <h2 class="section-title">{{ t('workExperience.sectionTitle') }}</h2>
        ...
        >
          ...
          <ul class="experience-card__achievements">
            <li
              ...
              :key="index"
              class="experience-card__achievement"
            >
              {{ achievement }}
            </li>
          </ul>
...
.experience-card__achievement:last-child {
  margin-bottom: 0;
}

.experience-card__achievement::before {
  content: '▪';
  position: absolute;
  left: 0;
  color: var(--primary-color);
