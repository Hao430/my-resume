...
export const resumeData: ResumeData = {
  ...
  "professionalSummary": {
    "strong": "技术顾问与架构落地：专注于团队 AI 编码工作流升级、代码资产安全审计与高可靠企业系统架构。主导 360°全景多模态云平台与 DocLake 数据湖系统等企业级从 0 到 1 架构，具备全流程需求诊断、系统设计、工程化交付与安全合规落地能力。",
    "comprehensive": "全栈造物与复杂系统：具备端到端全栈工程与复杂流水线构建能力，精通 Vue/React、TypeScript、FastAPI、Node.js 与分布式存储架构。主导构建五 Agent 协同自审系统（AgentScope）、多源文档统一解析管线（Docling/OCR/LLM）与向量化知识检索系统，实现产品体验与高吞吐性能的深度结合。",
    "outstanding": "独立研究与工程纪律：坚持实证研究与中英双语深度输出，持续探索 Agent 权限治理、CRA 漏洞报告与新型开发范式（发表《Your AI Agent Is Running as Root》等）。恪守“文档即代码”与高可观测性标准，以严谨的数据指标与高代码覆盖率保障工程资产质量。"
  },
  "skills": [
    {
      "name": "Vue.js",
