...
## 核心特性
- **技术栈**：Vue.js 3 + Vite + TypeScript + Vue Router
...
- **工作经历**：
  - 贵州建工监理咨询有限公司（产品支持实习生）
  - 学生党支部（副书记）
  - 大数据科创协会（会长）
  - 对应组件：`src/components/WorkExperience.vue`
- **荣誉证书**：电子商务"三创赛"省一等奖、"互联网+"省金奖、数学建模省二等奖、挑战杯省三等奖
...
---
**项目当前状态：** 核心功能已全部实现，包括个人信息、个人简介、技能展示、项目经验、工作经历和荣誉证书等模块。项目已完成组件化开发，数据与视图分离，采用 TypeScript 类型系统确保代码质量。网站已具备完整的响应式设计能力，可在不同设备上正常展示。
