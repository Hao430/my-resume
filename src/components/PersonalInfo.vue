...
<template>
  <section id="about" class="personal-info">
    <div class="container">
...
.personal-info__education {
  margin-bottom: var(--spacing-xl);
  animation: fadeInUp 0.6s ease-out 0.4s both;
}

.personal-info__university {
...
.personal-info__college,
.personal-info__major {
